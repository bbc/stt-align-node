...
const transcriptStt = require('../sample/data/ted-talk/ted-talk-kate.json').retval;
...
fs.writeFileSync('./sample/output/ted-talk-kate-realigned.json', JSON.stringify(result,null,2));