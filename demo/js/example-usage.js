...
const diffsListAsHtml = require('./index.js').diffsListAsHtml; // // file path relative to root


const transcriptText = fs.readFileSync('./sample/data/ted-talk/ted-talk-kate.txt').toString(); // // file path relative to this file.

const transcriptStt = require('../sample/data/ted-talk/ted-talk-kate-kaldi.json').retval; // console.log(transcriptStt)
// const transcriptStt = { 
//     words: [
...
console.log(result); // const htmlResult = diffsListAsHtml(result);
